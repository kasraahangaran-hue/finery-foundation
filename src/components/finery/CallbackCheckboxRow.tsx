...
export function CallbackCheckboxRow({
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-3 rounded-[var(--radius)] bg-finery-beige-300 px-4 py-3 pointer-events-none",
        className,
      )}
    >
      <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-[4px] bg-finery-purple-400">
